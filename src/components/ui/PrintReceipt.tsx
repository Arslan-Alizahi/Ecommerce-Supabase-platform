    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 print:bg-white print:block print:static print:inset-auto">
      <div className="print-receipt-content bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-auto print:shadow-none print:max-w-full print:max-h-full print:overflow-visible print:rounded-none">
        ...
        <div className="hidden print:block text-center mb-6">
          <h1 className="text-3xl font-bold">Pak Madina Mobile Shop</h1>
          <p className="text-sm text-gray-600">Your trusted mobile shop in Haripur</p>
          <p className="text-xs text-gray-500 mt-1">
            Ameer Khan Silkway Plaza, G.T Road, Haripur, KPK, Pakistan
          </p>
          <p className="text-xs text-gray-500">
            Phone: 0321-5737856 | 0318-0553648
          </p>
        </div>
        ...
        <div className="p-6 print:p-8">
          ...
          <div className="mb-6 pb-4 border-b border-dashed">
            ...
            <div className="mt-3 text-sm">
              <p className="text-gray-600">Billed By</p>
              <p className="font-semibold">Shahjahan Khurshid</p>
            </div>
          </div>
          ...
          <div className="text-center text-sm text-gray-600 pt-4 border-t">
            ...
            <p className="text-xs mb-2">For any queries, please contact us:</p>
            <p className="text-xs">0321-5737856 | 0318-0553648</p>
            <p className="text-xs mt-2">Pak Madina Mobile, G.T Road, Haripur, KPK</p>
            <div className="mt-4 pt-3 border-t border-dashed">
              <p className="text-xs text-gray-500">Developed & Maintained by arslandevs (Coding.Zoo)</p>
            </div>
          </div>
        </div>
