  ...
  const features = [
    {
      ...
      description: 'Browse through latest mobile phones, accessories, and gadgets',
    },
    {
      icon: Shield,
      title: 'Genuine Products',
      description: '100% original products with warranty and quality assurance',
    },
    {
      icon: Zap,
      title: 'Fast Service',
      description: 'Quick service and support in Haripur, KPK',
    },
    {
      icon: TrendingUp,
      title: 'Best Prices',
      description: 'Competitive pricing with the best deals in town',
    },
  ]
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center">
            ...
            >
              Your trusted mobile shop in Haripur, KPK
            </motion.p>
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <p className="text-xl mb-8 text-primary-100">
              Join hundreds of satisfied customers in Haripur and experience quality mobile shopping
            </p>
            <Link href="/products">
